...
const LANGS = {
  nl: {
    ...
    ui: {
      ...
      world_words:"Woorden", world_adventure:"Avontuur", world_numbers:"Getallen",
      world_letters:"Letters", world_quick:"Spelletjes",
      missions:"Opdrachten", missionDone:"Gedaan!",
      missionsHint:"Kleine opdrachten voor buiten het scherm.",
      missionsNote:"Niemand controleert het. Doe het samen en tik daarna op Gedaan.",
      ...
      promptMatch:"Welke groep hoort bij dit getal?", promptMakeNumber:"Hoe maak je",
      ...
      hintSoundAgain:"Luister nog eens, rustig.",
  ...
  bg: {
    ...
    ui: {
      ...
      world_words:"Думи", world_adventure:"Приключение", world_numbers:"Числа",
      world_letters:"Букви", world_quick:"Игрички",
      missions:"Задачки", missionDone:"Готово!",
      missionsHint:"Малки задачки за извън екрана.",
      missionsNote:"Никой не проверява. Направете го заедно и после натиснете Готово.",
      ...
      promptMatch:"Коя група е това число?", promptMakeNumber:"Как се прави",
  ...
  if("serviceWorker" in navigator && location.protocol === "https:"){
    window.addEventListener("load", () => {
      ...
      navigator.serviceWorker.addEventListener("message", (e) => {
        if(e.data && e.data.type === "cache-failed")
          console.warn("Офлайн кешът не се напълни:", e.data.message);
      });
      let reloading = false;
